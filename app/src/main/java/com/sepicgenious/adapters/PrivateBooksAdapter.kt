...
public class PrivateBooksAdapter(
    val context: Context?,
    val records: ArrayList<RecordsItem?>?
) :
    RecyclerView.Adapter<PrivateBooksAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        try {
            ...
            val urlImage: URL = URL(Urlmanager.ROOT_URL + recordItem.bookIcon!!)
        ...
        holder.itemView.setOnClickListener {
            context!!.startActivity(
                ...
                ).putExtra("bookId", recordItem!!.bookId)
            )
        }
