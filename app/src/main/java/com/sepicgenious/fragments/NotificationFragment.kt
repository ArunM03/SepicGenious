...
import com.sepicgenious.adapters.NotificationAdapter
...
class NotificationFragment : Fragment() {
    ...
    private lateinit var gradeBookAdapter: NotificationAdapter
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        gradeBookAdapter = NotificationAdapter(context, records)
        rv_books.adapter = gradeBookAdapter

        loadNextSyncDataApi(1)
    ...
    private fun loadNextSyncDataApi(page: Int) {
