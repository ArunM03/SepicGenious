...
import com.sepicgenious.utils.SharedPref.Companion.studentLogin
import kotlinx.android.synthetic.main.fragment_cart.*
import kotlinx.android.synthetic.main.fragment_home.*
import kotlinx.android.synthetic.main.fragment_home.rv_books
...
class CartFragment : Fragment() {
    ...
    private lateinit var gradeBookAdapter: CartBooksAdapter
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        gradeBookAdapter = CartBooksAdapter(context, records)
    ...
    private fun loadNextGradeFromApi(page: Int) {
        ...
        RetrofitClient.getResponse(context,
           null,
            RetrofitClient.getRegistrationApiService()!!.publicPrivateBooks(body),
